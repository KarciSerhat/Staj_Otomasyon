...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tüm Uygulama</h1>
        </div>
        <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="createModalForm" method="post" >
                        @csrf
                        <div class="mb-3">
                            <label for="title" class="form-label"><span class="text-danger" style="font-size: 20px">*</span> Uygulama Adı</label>
                            <input type="text" class="form-control" required id="title" name="title" placeholder="Uygulama Adı" value="{{ old('title') }}">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editModalForm" method="post" >
                        @csrf
                        <div class="mb-3">
                            <label for="titleUpdate" class="form-label"><span class="text-danger" style="font-size: 20px">*</span> Uygulama Adı</label>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $("#createModalForm").submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('admin.uygulama.create') }}",
                type: "POST",
                data: formData,
        ...
        $("#editModalForm").submit(function(event) {
            ...
            var formData = $(this).serialize();
            $.ajax({
                url: "{{ route('admin.uygulama.update') }}",
                type: "POST",
                data: formData,
                success: function(response) {
